...
export default function PropertiesPage() {
  ...
  const filters: PropertiesFilters = useMemo(() => {
    const f: PropertiesFilters = {
      ...
      priceMin: priceRange[0] > PRICE_RANGE[0] ? priceRange[0] : undefined,
      priceMax: priceRange[1] < PRICE_RANGE[1] ? priceRange[1] : undefined,
      propertyType: propertyType !== 'all' ? propertyType : undefined,
      operationType: operation !== 'all' ? operation : undefined,
      ...
      ...(advancedFilters.parkingSpaces != null && { parkingSpaces: advancedFilters.parkingSpaces }),
      ...(advancedFilters.constructionM2Min != null && { constructionM2Min: advancedFilters.constructionM2Min }),
      ...(advancedFilters.constructionM2Max != null && { constructionM2Max: advancedFilters.constructionM2Max }),
      ...(advancedFilters.landM2Min != null && { landM2Min: advancedFilters.landM2Min }),
      ...(advancedFilters.landM2Max != null && { landM2Max: advancedFilters.landM2Max }),
                        ...
                        {Array.from({ length: totalPages }, (_, i) => i + 1)
                          ...
                          .map((n) => (
                            <button
                              key={n}
                              type="button"
                              className={`h-10 min-w-[2.5rem] rounded-xl border px-2 font-medium transition-colors ${n === currentPage
