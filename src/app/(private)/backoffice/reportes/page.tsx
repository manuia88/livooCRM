...
const SalesTrendChart = dynamic(() => import('@/components/analytics/charts').then(mod => mod.SalesTrendChart), {
    ssr: false,
    loading: () => <div className="h-[300px] w-full bg-gray-50 animate-pulse rounded-2xl" />
})

const ClosingsChart = dynamic(() => import('@/components/analytics/charts').then(mod => mod.ClosingsChart), {
    ssr: false,
    loading: () => <div className="h-[300px] w-full bg-gray-50 animate-pulse rounded-2xl" />
})

const LeadSourceChart = dynamic(() => import('@/components/analytics/charts').then(mod => mod.LeadSourceChart), {
    ssr: false,
    loading: () => <div className="h-[300px] w-full bg-gray-50 animate-pulse rounded-2xl" />
})
