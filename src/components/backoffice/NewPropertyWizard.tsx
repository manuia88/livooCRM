...
/** Props para usar el wizard desde Propiedades/Nueva o Captaciones (módulos espejo) */
export interface NewPropertyWizardProps {
  title: string
...
export function NewPropertyWizard({ title: pageTitle, redirectOnSuccess, submitButtonLabel = 'Crear Propiedad' }: NewPropertyWizardProps) {
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-3 py-5 px-6 border-t border-[#E5E7EB] bg-white">
          ...
          {currentStep < totalSteps ? (
            ...
            <button
              ...
              style={{ backgroundColor: '#111827' }}
            >
              {createProperty.isPending ? 'Guardando…' : submitButtonLabel}
            </button>
          )}
        </div>
      </div>
