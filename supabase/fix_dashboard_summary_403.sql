-- ============================================================================
-- FIX CRÍTICO: Error 403 en get_dashboard_summary
-- Problema: La función intenta INSERTAR en user_objectives pero las políticas RLS no lo permiten
-- Solución: Agregar política INSERT y usar SECURITY DEFINER en la función
-- ============================================================================
...
-- Paso 1: Agregar política INSERT para user_objectives
